...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" media="screen" href="{{asset('./statics/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('./statics/css/reset.css')}}">
...
<div id="particles-js">
    <div class="login">
        ...
        <div class="login-center clearfix">
            <div class="login-center-img"><img src="{{asset('./statics/img/password.png')}}"></div>
